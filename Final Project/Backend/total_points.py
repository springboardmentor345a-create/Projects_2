...
def show_results_page():
    """Show the results page with all charts"""
    result = st.session_state.points_prediction_result
    
    # Add CSS for the result page styling
    st.markdown("""
    <style>
    ...
    with col1:
        if st.button("← Back", key="back_to_prediction_top"):
    ...
    <div style="text-align: center; padding: 1rem 0 3rem 0;">
        ...
        <p style="color: #94a3b8; font-size: 1.1rem; margin: 0; font-family: 'Inter', sans-serif;">
            Based on your input: {result['goals_scored']} goals scored, {result['goals_conceded']} goals conceded
        </p>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style="text-align:center; margin:3rem 0 2rem 0;">
        <h3 style="color:#e2e8f0; font-family:'Inter',sans-serif; font-size: 1.8rem;">Goals Statistics</h3>
    </div>
    """, unsafe_allow_html=True)
    ...
    with col1:
        st.markdown(f"""
        <div class="stat-card">
            <div class="stat-value" style="color: #10b981;">{result['goals_scored']}</div>
    ...
    with col2:
        st.markdown(f"""
        <div class="stat-card">
            <div class="stat-value" style="color: #ef4444;">{result['goals_conceded']}</div>
    ...
    <div style="margin-top: 4rem;">
        <h3 style="color:#e2e8f0; font-family:'Inter',sans-serif; text-align: center; margin-bottom: 2rem; font-size: 1.8rem;">📊 Visual Analysis</h3>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style="margin-top: 3rem;">
        <h3 style="color:#e2e8f0; font-family:'Inter',sans-serif; margin-bottom: 1.5rem; text-align: center; font-size: 1.8rem;">Historical Comparison</h3>
    </div>
    """, unsafe_allow_html=True)
    ...
    if st.button("← Make New Prediction", use_container_width=False, key="new_prediction_btn"):
        st.session_state.points_prediction_result = None
        st.rerun()
...
def total_points_prediction_page():
    ...
    /* Hide Streamlit number input labels only */
    ...
    with st.container():
        ...
        <div class="input-section">
            <h2 style="color:#e2e8f0; font-family:'Inter',sans-serif; margin-bottom:2rem; text-align:center;">Enter Goals Statistics</h2>
        """, unsafe_allow_html=True)
        
        col1, col2, col3 = st.columns(3)
        
        with col1:
            st.markdown('<div style="background: rgba(30, 41, 59, 0.7); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 12px; padding: 1.5rem; margin-bottom: 1rem;">', unsafe_allow_html=True)
            st.markdown('<div style="color: #ffffff; font-weight: 600; font-size: 1.2rem; margin-bottom: 1rem; text-align: center;">⚽ Goals Scored</div>', unsafe_allow_html=True)
            ...
            <div style="margin-top: 1rem; text-align: center;">
                <div style="font-size: 3rem; color: #10b981; font-family: 'Orbitron', sans-serif;">{goals_scored}</div>
        ...
        with col2:
            st.markdown('<div style="background: rgba(30, 41, 59, 0.7); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 12px; padding: 1.5rem; margin-bottom: 1rem;">', unsafe_allow_html=True)
            st.markdown('<div style="color: #ffffff; font-weight: 600; font-size: 1.2rem; margin-bottom: 1rem; text-align: center;">🛡️ Goals Conceded</div>', unsafe_allow_html=True)
            ...
            st.markdown(f"""
            <div style="margin-top: 1rem; text-align: center;">
                <div style="font-size: 3rem; color: #ef4444; font-family: 'Orbitron', sans-serif;">{goals_conceded}</div>
        ...
        with col3:
            st.markdown('<div style="background: rgba(30, 41, 59, 0.7); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 12px; padding: 1.5rem; margin-bottom: 1rem;">', unsafe_allow_html=True)
            st.markdown('<div style="color: #ffffff; font-weight: 600; font-size: 1.2rem; margin-bottom: 1rem; text-align: center;">📈 Goal Difference</div>', unsafe_allow_html=True)
            ...
            st.markdown(f"""
            <div style="margin-top: 1rem; text-align: center;">
                <div style="font-size: 3rem; color: {gd_color}; font-family: 'Orbitron', sans-serif;">{gd_symbol}{goal_difference}</div>
        ...
        st.markdown('<div style="background: rgba(30, 41, 59, 0.7); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 12px; padding: 1.5rem; margin-bottom: 1rem;">', unsafe_allow_html=True)
        st.markdown('<div style="color: #ffffff; font-weight: 600; font-size: 1.2rem; margin-bottom: 1rem; text-align: center;">📊 Goals Summary</div>', unsafe_allow_html=True)
        ...
        predict_button = st.button("Predict Final Points", use_container_width=False, key="predict_points_btn")
